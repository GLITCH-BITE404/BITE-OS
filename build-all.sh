...
ls repo/x86_64/bite-os-1.1-8-*.pkg.tar.* >/dev/null 2>&1 \
    && ok "bite-os 1.1-8 in repo" \
    || echo "${c_y}  ! warning: bite-os 1.1-8 not found in repo — check the makepkg output${c_0}"
